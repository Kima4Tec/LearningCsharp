    ...
    internal class Opgave41til50
    {
        ...
        public static void Opgave45()
        {
            ...
            while (valg != "9") //while looper indtil 9 bliver tastet
            {
                ...
                Console.WriteLine("-------------------------------------");
                Console.WriteLine("|||      * Cirkus Baldrian *      |||");
                Console.WriteLine("-------------------------------------");
        ...
        public static void Opgave46()
        {
            ...
            while (valg != "9") //while looper indtil 9 bliver tastet
            {
                Console.Clear(); //jeg clearer før menuen for det er pænest, når den kaldes igen
                Console.WriteLine(" ------------------------------------------------------------------------------------- ");
                Console.WriteLine("|                             |   Ballerup Svømmehal   |                              |");
                Console.WriteLine("|                              ----------------------                                 |");
        ...
        {
            //Lav et program hvor man kan indtaste to tekster.Programmet skal så fortælle hvilken tekst der er længst.
        ...
        {
            //Lav et program hvor man indtaster en tekst og programmet fjerner alle mellemrummene fra teksten og 
            //udskriver den.
            ...
            Console.WriteLine();
            Console.WriteLine("Nu fjernes alle mellemrum i teksten.");
            Console.Write("Vent et øjeblik.");
        ...
        public static void Opgave49()
        {
            ...
            string nyTekst = string.Empty; //ny variabel til omvendt tekst bliver dannet
            for (int i = tekst.Length - 1; i >= 0; i--) //for-løkke, der skal hente et tegn ad gangen,
                                                        ...
                                                        //Det er tekst.Length - 1 fordi den starter på 
                                                        //herefter skal den tælle ned med minus 1 indtil i >= 0
            {
                //nyTekst += tekst[i];
        ...
        public static void Opgave50()
        {
            ...
            string teksten = "Der var en mand, der boede sammen med sin kat, langt ude på landet i et gammelt hus.";
